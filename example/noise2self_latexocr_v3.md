...
$$ \begin{array}{r l}{\infty}&{{}{}\quad\left\lfloor\lambda\atop{\pm}\right.}\quad\left\lceil\left\lfloor\lambda\right\rceil\quad\right\rceil}\end{array} $$
...
of radius r surrounding it, and the “donut” median ﬁlter fr, which replaces each pixel with the median over the same $$ \begin{array}{l}{\operatorname{\bigcup_{i}^{n}}\end{array} $$

disk excluding the center, on an image with i.i.d. Gaussian since the pixels of x in J are replaced before applying gθ, $$ \stackrel{\mathbb{C}}{\longrightarrow}_{\frac{\mathrm{r}}{\textstyle\frac{1}{\textstyle\strut}}} $$
...
$$ \left\lfloor\left\lfloor\begin{array}{l l}\end{array}\right\ {\mathrm{}\quad} $$
